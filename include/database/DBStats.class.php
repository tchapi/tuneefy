...
class DBStats
{
    ...
    // Retrieves, for each platform, the number of tracks that have a link on this platform,
    // thus giving an idea of the catalogue span for the common end-user searches
    //
