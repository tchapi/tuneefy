/*global $,console,$all_platforms,Links,Item*/
/*jslint browser: true*/
var MAX_API_CALLS_PER_PERIOD = 2; // 250e sec

var Tuneefy = function(initialController) {
...
Tuneefy.prototype.runGets = function() {
    ...
    if (this.lookedUpPlatform !== null && this.lookedUpPlatform !== -1 && $.inArray(this.lookedUpPlatform + '', $all_platforms) !== -1) {
...
Tuneefy.prototype.getPlaylistData = function() {
    ...
    $.getJSON("/include/share/getPlaylist.php", {
        str: this.query
    }, $.proxy(function(data) {
...
Tuneefy.prototype.findPlaylistEquivalents = function(offset) {
    ...
    for (i = offset; i < limit; i += 1) {
        ...
        $.getJSON("/include/share/get.php", {
            id: this.platforms,
            query: this.results[i].title + " " + this.results[i].artist,
            itemType: 0,
            limit: 1,
            json_key: i
        }, $.proxy(function(data) {
    ...
    if (offset + MAX_API_CALLS_PER_PERIOD >= this.results.length) {
        return;
    }
    ...
    window.setTimeout($.proxy(function() {
        this.findPlaylistEquivalents(offset + MAX_API_CALLS_PER_PERIOD);
    }, this), 250);
